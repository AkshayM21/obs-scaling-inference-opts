    ...
    for opt in args.optimization:
        ...
        for model_tup in models:
            ...
            if isinstance(model_tup, str):
                ...
                model_args=f"pretrained={model},tensor_parallel_size=1,dtype=auto,gpu_memory_utilization=0.8,data_parallel_size=2",
                tasks=tasks,
                batch_size="auto",
                ...
                for revision in revisions:
                    ...
                    results = simple_evaluate(model="vllm", 
                        model_args=f"pretrained={model},tensor_parallel_size=1,dtype=auto,gpu_memory_utilization=0.8,data_parallel_size=2,revision={revision}",
                        tasks=tasks,
                        batch_size="auto",
                        num_fewshot=None,  # from default=None
                        use_cache=None,  # from default=None
